...
'Алгоритм Кнута-Морріса-Пратта (KMP) для пошуку підрядка в тексті'
...
pattern_1_r = "алгоритмів"
pattern_1_f = "Oleg"
pattern_2_r = "ефективність"
pattern_2_f = "Oleg"
#
def time_(func, name, text, pattern):
...
time_(boyer_moore_search, 'boyer_moore_search', text_1, pattern_1_r)
time_(kmp_search, 'kmp_search', text_1, pattern_1_r)
time_(rabin_karp_search, 'rabin_karp_search', text_1, pattern_1_r)


print('\ntext_1, pattern_1_f\n')

time_(boyer_moore_search, 'boyer_moore_search', text_1, pattern_1_f)
time_(kmp_search, 'kmp_search', text_1, pattern_1_f)
time_(rabin_karp_search, 'rabin_karp_search', text_1, pattern_1_f)


print('\ntext_2, pattern_2_r\n')

time_(boyer_moore_search, 'boyer_moore_search', text_2, pattern_2_r)
time_(kmp_search, 'kmp_search', text_2, pattern_2_r)
time_(rabin_karp_search, 'rabin_karp_search', text_2, pattern_2_r)


print('\ntext_2, pattern_2_f\n')

time_(boyer_moore_search, 'boyer_moore_search', text_2, pattern_2_f)
time_(kmp_search, 'kmp_search', text_2, pattern_2_f)
time_(rabin_karp_search, 'rabin_karp_search', text_2, pattern_2_f)
